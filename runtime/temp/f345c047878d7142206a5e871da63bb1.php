					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673ab2d6a76fc=explode(',',$maccms['search_hot']); if(is_array($_673ab2d6a76fc) || $_673ab2d6a76fc instanceof \think\Collection || $_673ab2d6a76fc instanceof \think\Paginator): if( count($_673ab2d6a76fc)==0 ) : echo "" ;else: foreach($_673ab2d6a76fc as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673ab2d6a75bd=explode(',',$maccms['search_hot']); if(is_array($_673ab2d6a75bd) || $_673ab2d6a75bd instanceof \think\Collection || $_673ab2d6a75bd instanceof \think\Paginator): if( count($_673ab2d6a75bd)==0 ) : echo "" ;else: foreach($_673ab2d6a75bd as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
						...
						<div class="mxone-pannel_hd">
							<div class="mxone-pannel__head active bottom-line clearfix">
								...
								<ul class="navuser nav-tabs pull-right">
									...
									<li class="active"><a href="<?php echo url('user/popedom'); ?>">我的权限</a></li>
								</ul>
							</div>																		
						</div>
						<div class="mxone-pannel_bd clearfix">
							<ul class="mxone-vodlist__text striped to-color col-pd text-center clearfix">
								<li class="striped-head clearfix">
									<span class="col-xs-wide-25">类目</span>
									<span class="col-xs-wide-15">列表页</span>
									<span class="col-xs-wide-15">内容页</span>
									<span class="col-xs-wide-15">播放页</span>
									<span class="col-xs-wide-15">下载页</span>
									<span class="col-xs-wide-15">试看</span>
								</li>
								...
								<li class="clearfix">										
									<span class="col-xs-wide-25"><?php echo $vo['type_name']; ?></span>
									<?php if(is_array($vo['popedom']) || $vo['popedom'] instanceof \think\Collection || $vo['popedom'] instanceof \think\Paginator): if( count($vo['popedom'])==0 ) : echo "" ;else: foreach($vo['popedom'] as $key=>$v2): ?>
									<span class="col-xs-wide-15"><?php if($v2 == 1): ?><i>√</i><?php else: ?><i>×</i><?php endif; ?></span>
									<?php endforeach; endif; else: echo "" ;endif; ?>																									
								</li>
								...
								<li class="clearfix">										
									<span class="col-xs-wide-25"><?php echo $child['type_name']; ?></span>
									<?php if(is_array($vo['popedom']) || $vo['popedom'] instanceof \think\Collection || $vo['popedom'] instanceof \think\Paginator): if( count($vo['popedom'])==0 ) : echo "" ;else: foreach($vo['popedom'] as $key=>$v2): ?>
									<span class="col-xs-wide-15"><?php if($v2 == 1): ?><i>√</i><?php else: ?><i>×</i><?php endif; ?></span>
									<?php endforeach; endif; else: echo "" ;endif; ?>																									
								</li>
