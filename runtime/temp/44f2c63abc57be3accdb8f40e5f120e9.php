<?php if (!defined('THINK_PATH')) exit(); /*a:15:{s:39:"template/mxone/html_tplmx/vod/type.html";i:1629606726;s:62:"/www/wwwroot/video/template/mxone/html_tplmx/seo/vod_type.html";i:1629606718;s:64:"/www/wwwroot/video/template/mxone/html_tplmx/public/include.html";i:1629606714;s:58:"/www/wwwroot/video/template/mxone/html_tplmx/ads/adqj.html";i:1629606708;s:61:"/www/wwwroot/video/template/mxone/html_tplmx/public/head.html";i:1731557950;s:60:"/www/wwwroot/video/template/mxone/html_tplmx/vod/typetb.html";i:1629606728;s:60:"/www/wwwroot/video/template/mxone/html_tplmx/vod/typeho.html";i:1629606726;s:63:"/www/wwwroot/video/template/mxone/html_tplmx/public/vodbox.html";i:1731568955;s:60:"/www/wwwroot/video/template/mxone/html_tplmx/vod/typefl.html";i:1629606726;s:60:"/www/wwwroot/video/template/mxone/html_tplmx/vod/typedq.html";i:1629606726;s:63:"/www/wwwroot/video/template/mxone/html_tplmx/public/paging.html";i:1629606714;s:61:"/www/wwwroot/video/template/mxone/html_tplmx/public/foot.html";i:1629606736;s:65:"/www/wwwroot/video/template/mxone/html_tplmx/public/tcnotice.html";i:1629606714;s:64:"/www/wwwroot/video/template/mxone/html_tplmx/public/website.html";i:1650943918;s:58:"/www/wwwroot/video/template/mxone/html_tplmx/ads/addb.html";i:1629606708;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
 <head>
					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673c6dfa54105=explode(',',$maccms['search_hot']); if(is_array($_673c6dfa54105) || $_673c6dfa54105 instanceof \think\Collection || $_673c6dfa54105 instanceof \think\Paginator): if( count($_673c6dfa54105)==0 ) : echo "" ;else: foreach($_673c6dfa54105 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673c6dfa54029=explode(',',$maccms['search_hot']); if(is_array($_673c6dfa54029) || $_673c6dfa54029 instanceof \think\Collection || $_673c6dfa54029 instanceof \think\Paginator): if( count($_673c6dfa54029)==0 ) : echo "" ;else: foreach($_673c6dfa54029 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
  ...
  <div class="content">
       ...
       <?php if($obj['childids']||$obj['parent']['childids']): if($obj['type_pid'] == 0): $__TAG__ = '{"parent":"'.$obj['type_id'].'","order":"asc","by":"sort","id":"vo2","key":"key2"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key2 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($key2 % 2 );++$key2;?>
          ...
          <div class="block-box-item <?php if($vo2['type_id'] == $obj['type_id']): ?>selected<?php endif; ?>">
            ...
            <div class="block-box-bg"><?php echo $vo2['type_name']; ?></div>
          	...
          	<?php endforeach; endif; else: echo "" ;endif; endif; else: $_673c6dfa53bb0=explode(',',$obj['type_extend']['area']); if(is_array($_673c6dfa53bb0) || $_673c6dfa53bb0 instanceof \think\Collection || $_673c6dfa53bb0 instanceof \think\Paginator): if( count($_673c6dfa53bb0)==0 ) : echo "" ;else: foreach($_673c6dfa53bb0 as $key1=>$vo1): ?> 
     ...
     <!-- 分类页分类 -->
      ...
      <div class="module-list module-lines-list">
        <div class="module-items">
            <?php if($mxonest['mxcms']['s2']['qzslt'] == 1): $__TAG__ = '{"num":"12","type":"current","order":"desc","by":"hits","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;if($mxonest['mxcms']['s2']['qzslt'] == 0): ?>	  
        ...
        <?php endif; endforeach; endif; else: echo "" ;endif; else: $__TAG__ = '{"num":"16","type":"current","order":"desc","by":"hits","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;if($mxonest['mxcms']['s2']['qzslt'] == 0): ?>	  
                <div class="module-item">
				<div class="module-item-cover">
					<div class="module-item-pic">
						<a href="<?php if($mxonest['mxcms']['s2']['tzzt'] == 1): ?><?php echo mac_url_vod_play($vo); else: ?><?php echo mac_url_vod_detail($vo); endif; ?>" title="<?php echo $vo['vod_name']; ?>" >
    ...
    <?php endif; ?>  <!-- 分类页热播 -->
     ...
     <?php endforeach; endif; else: echo "" ;endif; ?>  <!-- 有二级分类 -->
	    ...
	    <?php else: $_673c6dfa53655=explode(',',$obj['type_extend']['area']); if(is_array($_673c6dfa53655) || $_673c6dfa53655 instanceof \think\Collection || $_673c6dfa53655 instanceof \think\Paginator): if( count($_673c6dfa53655)==0 ) : echo "" ;else: foreach($_673c6dfa53655 as $key1=>$vo1): ?> 			
        <div class="module module-bg">
      <div class="module-heading">
