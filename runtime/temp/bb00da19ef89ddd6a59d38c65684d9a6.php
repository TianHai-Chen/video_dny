<?php if (!defined('THINK_PATH')) exit(); /*a:15:{s:39:"template/mxone/html_tplmx/vod\type.html";i:1629606726;s:70:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\seo\vod_type.html";i:1629606718;s:72:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\public\include.html";i:1629606714;s:66:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\ads\adqj.html";i:1629606708;s:69:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\public\head.html";i:1731557950;s:68:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\vod\typetb.html";i:1629606728;s:68:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\vod\typeho.html";i:1629606726;s:71:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\public\vodbox.html";i:1731568955;s:68:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\vod\typefl.html";i:1629606726;s:68:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\vod\typedq.html";i:1629606726;s:71:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\public\paging.html";i:1629606714;s:69:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\public\foot.html";i:1629606736;s:73:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\public\tcnotice.html";i:1629606714;s:72:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\public\website.html";i:1650943918;s:66:"D:\phpstudy_pro\WWW\video1\template\mxone\html_tplmx\ads\addb.html";i:1629606708;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
 <head>
					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673c4ab0323f4=explode(',',$maccms['search_hot']); if(is_array($_673c4ab0323f4) || $_673c4ab0323f4 instanceof \think\Collection || $_673c4ab0323f4 instanceof \think\Paginator): if( count($_673c4ab0323f4)==0 ) : echo "" ;else: foreach($_673c4ab0323f4 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673c4ab032275=explode(',',$maccms['search_hot']); if(is_array($_673c4ab032275) || $_673c4ab032275 instanceof \think\Collection || $_673c4ab032275 instanceof \think\Paginator): if( count($_673c4ab032275)==0 ) : echo "" ;else: foreach($_673c4ab032275 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
  ...
  <div class="content">
       ...
       <?php if($obj['childids']||$obj['parent']['childids']): if($obj['type_pid'] == 0): $__TAG__ = '{"parent":"'.$obj['type_id'].'","order":"asc","by":"sort","id":"vo2","key":"key2"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key2 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo2): $mod = ($key2 % 2 );++$key2;?>
          ...
          <div class="block-box-item <?php if($vo2['type_id'] == $obj['type_id']): ?>selected<?php endif; ?>">
            ...
            <div class="block-box-bg"><?php echo $vo2['type_name']; ?></div>
          	...
          	<?php endforeach; endif; else: echo "" ;endif; endif; else: $_673c4ab03184b=explode(',',$obj['type_extend']['area']); if(is_array($_673c4ab03184b) || $_673c4ab03184b instanceof \think\Collection || $_673c4ab03184b instanceof \think\Paginator): if( count($_673c4ab03184b)==0 ) : echo "" ;else: foreach($_673c4ab03184b as $key1=>$vo1): ?> 
    ...
    <?php endif; ?>  <!-- 分类页热播 -->
     ...
     <?php endforeach; endif; else: echo "" ;endif; ?>  <!-- 有二级分类 -->
	    ...
	    <?php else: $_673c4ab030cca=explode(',',$obj['type_extend']['area']); if(is_array($_673c4ab030cca) || $_673c4ab030cca instanceof \think\Collection || $_673c4ab030cca instanceof \think\Paginator): if( count($_673c4ab030cca)==0 ) : echo "" ;else: foreach($_673c4ab030cca as $key1=>$vo1): ?> 			
        <div class="module module-bg">
      <div class="module-heading">
