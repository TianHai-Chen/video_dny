					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673ab2d0063d2=explode(',',$maccms['search_hot']); if(is_array($_673ab2d0063d2) || $_673ab2d0063d2 instanceof \think\Collection || $_673ab2d0063d2 instanceof \think\Paginator): if( count($_673ab2d0063d2)==0 ) : echo "" ;else: foreach($_673ab2d0063d2 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673ab2d006283=explode(',',$maccms['search_hot']); if(is_array($_673ab2d006283) || $_673ab2d006283 instanceof \think\Collection || $_673ab2d006283 instanceof \think\Paginator): if( count($_673ab2d006283)==0 ) : echo "" ;else: foreach($_673ab2d006283 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
						...
						<div class="mxone-pannel_hd">
							<div class="mxone-pannel__head active bottom-line clearfix">
								...
								<ul class="navuser nav-tabs pull-right">
									<li class="active"><a href="<?php echo url('user/orders'); ?>">在线充值记录</a></li>
							...
							<form id="form1" name="form1" method="post">
								<ul class="mxone-vodlist__text striped to-color col-pd clearfix">
									<li class="striped-head clearfix">
										...
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs">仙豆</span>
									...
									<li class="clearfix">										
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs text-muted"><?php echo $vo['order_id']; ?></span>
										<span class="col-md-wide-45 col-sm-wide-45 col-xs-wide-7"><?php echo $vo['order_code']; ?></span>
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs">-<?php echo $vo['order_price']; ?></span>
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs">+<?php echo $vo['order_points']; ?></span>
										<span class="col-md-wide-15 col-sm-wide-15 hidden-xs"><?php echo date('Y-m-d',$vo['order_time']); ?></span>
										<span class="col-md-wide-10 col-sm-wide-10 col-xs-wide-3 text-right">
											<?php if($vo['order_status'] == 1): ?><span class="text-muted">已支付</span><?php else: ?><a class="text-red" href="<?php echo url('user/pay'); ?>?order_code=<?php echo $vo['order_code']; ?>" class="delete">未支付</a><?php endif; ?>
										</span>																			
									</li>
				  					<?php endforeach; endif; else: echo "" ;endif; ?>
								</ul>
