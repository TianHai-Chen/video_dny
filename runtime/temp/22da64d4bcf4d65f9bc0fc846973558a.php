<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:74:"D:\phpstudy_pro\WWW\video1/application/admin\view\system\configweixin.html";i:1638283348;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab">
            ...
            <div class="layui-tab-item layui-show">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="weixin[duijie]" placeholder="请以http 或 https开头，公众号后台的对接地址为【http://wx.lvdoui.cn/inc/weixin.php】" value="<?php echo $config['weixin']['duijie']; ?>" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
