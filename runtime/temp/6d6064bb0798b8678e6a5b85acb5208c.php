<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\phpstudy_pro\WWW\video1/application/admin\view\glog\index.html";i:1731729505;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <form class="layui-form " method="post">
                <div class="layui-input-inline w150">
                    <select name="type">
                        ...
                        <option value="1" <?php if($param['type'] == '1'): ?>selected <?php endif; ?>>仙豆充值</option>
                        ...
                        <option value="7" <?php if($param['type'] == '7'): ?>selected <?php endif; ?>>仙豆升级</option>
                        <option value="8" <?php if($param['type'] == '8'): ?>selected <?php endif; ?>>仙豆消费</option>
                        <option value="9" <?php if($param['type'] == '9'): ?>selected <?php endif; ?>>仙豆提现</option>
                    </select>
                </div>
     ...
     <form class="layui-form " method="post" id="pageListForm">
         <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <td><?php echo $vo['glog_id']; ?></td>
                <td>[<?php echo $vo['user_id']; ?>]<?php echo $vo['user_name']; ?></td>
                <td><?php echo mac_get_glog_type_text($vo['glog_type']); ?></td>
                <td><?php if(in_array($vo['glog_type'],[1,3,5])): ?>+<?php else: ?>-<?php endif; ?><?php echo $vo['glog_gold']; ?></td>
                <td><?php echo $vo['glog_remarks']; ?></td>
                <td><?php echo mac_day($vo['glog_time'],color); ?></td>
                <td>
                    <a class="layui-badge-rim j-tr-del" data-href="<?php echo url('del?ids='.$vo['glog_id']); ?>" href="javascript:;" title="删除">删除</a>
                </td>
            </tr>
...
<script type="text/javascript">
    var curUrl="<?php echo url('glog/index',$param); ?>";
