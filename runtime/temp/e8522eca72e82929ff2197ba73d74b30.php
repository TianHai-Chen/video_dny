					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673d465ed3e1a=explode(',',$maccms['search_hot']); if(is_array($_673d465ed3e1a) || $_673d465ed3e1a instanceof \think\Collection || $_673d465ed3e1a instanceof \think\Paginator): if( count($_673d465ed3e1a)==0 ) : echo "" ;else: foreach($_673d465ed3e1a as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673d465ed3d34=explode(',',$maccms['search_hot']); if(is_array($_673d465ed3d34) || $_673d465ed3d34 instanceof \think\Collection || $_673d465ed3d34 instanceof \think\Paginator): if( count($_673d465ed3d34)==0 ) : echo "" ;else: foreach($_673d465ed3d34 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
