...
<html lang="zh-cn">
	...
	<meta name="keywords" content="修改资料 - 会员中心 - <?php echo $maccms['site_name']; ?>">
	<meta name="description" content="修改资料 - 会员中心 - <?php echo $maccms['site_name']; ?>">
					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673ab2d531b7e=explode(',',$maccms['search_hot']); if(is_array($_673ab2d531b7e) || $_673ab2d531b7e instanceof \think\Collection || $_673ab2d531b7e instanceof \think\Paginator): if( count($_673ab2d531b7e)==0 ) : echo "" ;else: foreach($_673ab2d531b7e as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673ab2d531a6a=explode(',',$maccms['search_hot']); if(is_array($_673ab2d531a6a) || $_673ab2d531a6a instanceof \think\Collection || $_673ab2d531a6a instanceof \think\Paginator): if( count($_673ab2d531a6a)==0 ) : echo "" ;else: foreach($_673ab2d531a6a as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
						...
						<div class="mxone-pannel_hd">
							<div class="mxone-pannel__head active bottom-line clearfix">
								...
								<ul class="navuser nav-tabs pull-right">
									<li class="hidden-xs"><a href="<?php echo url('user/index'); ?>">基本资料</a></li>
									<li class="active"><a href="<?php echo url('user/info'); ?>">修改信息</a></li>
						...
						<div class="mxone-pannel_bd clearfix">
							<div class="mxone-user__form col-pd clearfix">
								<form id="fm" name="fm" method="post" action="" >
									<p><span class="xiang active">用户名：</span><?php echo $obj['user_name']; ?></p>
									...
									<p class="top-line-dot"><span class="xiang">QQ号码：</span><input type="text" name="user_qq" class="form-control" value="<?php echo $obj['user_qq']; ?>" placeholder="QQ号码"></p>
									<?php if($obj['user_email'] != ''): ?>
										<p class="top-line-dot"><span class="xiang">邮箱：</span><input type="text" name="user_email" class="form-control" readonly="readonly" value="<?php echo $obj['user_email']; ?>">[<a class="btn_unbind" ac="email" href="javascript:;">解绑</a>]</p>
									<?php else: ?>
										<p class="top-line-dot"><span class="xiang">邮箱：</span><input type="text" name="user_email" class="form-control" value="" placeholder="邮箱">[<a href="<?php echo url('user/bind'); ?>?ac=email">绑定</a>]</p>
									<?php endif; if($obj['user_phone'] != ''): ?>
									<p class="top-line-dot"><span class="xiang">手机：</span><input type="text" name="user_phone" class="form-control" readonly="readonly" value="<?php echo $obj['user_phone']; ?>">[<a class="btn_unbind" ac="phone" href="javascript:;">解绑</a>]</p>
									<?php else: ?>
									<p class="top-line-dot"><span class="xiang">手机：</span><input type="text" name="user_phone" class="form-control" value="" placeholder="手机号">[<a class="btn_unbind" href="<?php echo url('user/bind'); ?>?ac=phone">绑定</a>]</p>
									<?php endif; ?>
				
									<p class="top-line-dot"><span class="xiang">找回密码问题：</span><input type="text" name="user_question" class="form-control" value="<?php echo $obj['user_question']; ?>" placeholder="找回密码问题"></p>
									<p class="top-line-dot"><span class="xiang">找回密码答案：</span><input type="text" name="user_answer" class="form-control" value="<?php echo $obj['user_answer']; ?>" placeholder="找回密码答案"></p>
									<p class="top-line-dot"><span class="xiang"></span>
										<input type="button" id="btn_submit" class="btn btn-primary" value="保存">
										&nbsp;&nbsp;&nbsp;<a href="<?php echo url('user/findpass'); ?>">忘记密码了？</a>
									</p>
								</form>
							</div>																							
						</div>		
