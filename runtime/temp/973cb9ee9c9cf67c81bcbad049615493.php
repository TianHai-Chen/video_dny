					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_6735b48b796b5=explode(',',$maccms['search_hot']); if(is_array($_6735b48b796b5) || $_6735b48b796b5 instanceof \think\Collection || $_6735b48b796b5 instanceof \think\Paginator): if( count($_6735b48b796b5)==0 ) : echo "" ;else: foreach($_6735b48b796b5 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_6735b48b795b5=explode(',',$maccms['search_hot']); if(is_array($_6735b48b795b5) || $_6735b48b795b5 instanceof \think\Collection || $_6735b48b795b5 instanceof \think\Paginator): if( count($_6735b48b795b5)==0 ) : echo "" ;else: foreach($_6735b48b795b5 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
						...
						<div class="mxone-pannel_bd clearfix">
							<form id="form1" name="form1" method="post">
								<ul class="mxone-vodlist__text striped to-color col-pd clearfix">
									...
									<li class="clearfix">										
										<span class="col-md-wide-10 col-sm-wide-35 hidden-xs"><input type="checkbox" name="ids[]" id="checkbox" class="checkboxinput" value="<?php echo $vo['ulog_id']; ?>"/></span>
										<span class="col-md-wide-2 col-sm-wide-10 hidden-xs text-muted"><?php echo $vo['ulog_id']; ?></span>
