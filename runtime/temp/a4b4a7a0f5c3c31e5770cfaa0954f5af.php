<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"D:\phpstudy_pro\WWW\video1/application/admin\view\extend\pay\epay.html";i:1663254668;}*/ ?>
<div class="layui-tab-item">

    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 30px;">
        <legend>明帝微信支付
            <a target="_blank" href="https://www.zhapay.com/ad_8rRGj4nN.html" class="layui-btn layui-btn-primary">点击进入注册</a>
        </legend>
    </fieldset>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline w400">
            <input type="text" name="pay[epay][apiurl]" placeholder="默认填写: http://pay.zmyzf.cn/" value="<?php echo $config['pay']['epay']['apiurl']; ?>" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">商家收款平台：</label>
        <div class="layui-input-inline w400">
            <input type="text" name="pay[epay][type]" placeholder="" value="<?php echo $config['pay']['epay']['type']; ?>" class="layui-input">
        </div>
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline w400">
            <input type="text" name="pay[epay][name]" placeholder="" value="<?php echo $config['pay']['epay']['name']; ?>" class="layui-input">
        </div>
    </div>
    <!--<div class="layui-form-item">-->
