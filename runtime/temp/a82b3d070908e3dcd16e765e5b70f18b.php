<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\phpstudy_pro\WWW\video1/application/admin\view\extend\pay\alipay.html";i:1613485638;}*/ ?>
<div class="layui-tab-item ">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <textarea name="pay[alipay][public_key]" class="layui-textarea"><?php echo $config['pay']['alipay']['public_key']; ?></textarea>
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">私钥：</label>
        <div class="layui-input-block">
            <textarea name="pay[alipay][private_key]" class="layui-textarea"><?php echo $config['pay']['alipay']['private_key']; ?></textarea>
        </div>
    </div>
</div>
