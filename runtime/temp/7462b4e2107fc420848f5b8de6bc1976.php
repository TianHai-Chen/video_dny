<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"D:\phpstudy_pro\WWW\video1/application/admin\view\vod\batch.html";i:1731729505;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    ...
    <form class="layui-form" method="post" action="">
            ...
            <div class="center mb10">
                ...
                <div class="layui-input-inline w150">
                    <select name="level">
                        ...
                        <option value="5" <?php if($param['level'] == '5'): ?>selected <?php endif; ?>>推荐5-首页猜你喜欢</option>
                        ...
                        <option value="8" <?php if($param['level'] == '8'): ?>selected <?php endif; ?>>推荐8-分类幻灯片</option>
                        <option value="9" <?php if($param['level'] == '9'): ?>selected <?php endif; ?>>推荐9-首页幻灯片</option>
                    </select>
                </div>
                <div class="layui-input-inline w150">
                    <select name="lock">
        ...
        <div class="layui-field-box">
                ...
                <div class="layui-inline">
                    ...
                    <div class="layui-input-inline" style="width: 100px;">
                        <select name="val_level">
                            ...
                            <option value="5" >推荐5-首页猜你喜欢</option>
                            <option value="6" >推荐6</option>
                            <option value="7" >推荐7</option>
                            <option value="8" >推荐8-动漫幻灯片</option>
                            <option value="9" >推荐9-首页幻灯片</option>
                        </select>
                    </div>
                </div>
            </div>
            ...
            <div class="layui-form-item">
                <div class="layui-inline">
                    <label class="layui-form-label"><input type="checkbox" lay-ignore value="1" name="ck_points">仙豆</label>
                    <div class="layui-input-inline" style="width: 100px;">
                        <input type="text" name="val_points_play" required  placeholder="播放仙豆" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-input-inline" style="width: 100px;">
                        <input type="text" name="val_points_down" required  placeholder="下载仙豆" autocomplete="off" class="layui-input">
                    </div>
                </div>
            </div>
