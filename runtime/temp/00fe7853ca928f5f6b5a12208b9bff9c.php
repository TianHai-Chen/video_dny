<?php if (!defined('THINK_PATH')) exit(); /*a:10:{s:43:"template/mxone/html_tplmx/user/upgrade.html";i:1731913945;s:64:"/www/wwwroot/video/template/mxone/html_tplmx/public/include.html";i:1629606714;s:58:"/www/wwwroot/video/template/mxone/html_tplmx/ads/adqj.html";i:1629606708;s:62:"/www/wwwroot/video/template/mxone/html_tplmx/user/include.html";i:1629606720;s:61:"/www/wwwroot/video/template/mxone/html_tplmx/public/head.html";i:1731557950;s:59:"/www/wwwroot/video/template/mxone/html_tplmx/user/head.html";i:1731572890;s:61:"/www/wwwroot/video/template/mxone/html_tplmx/public/foot.html";i:1629606736;s:65:"/www/wwwroot/video/template/mxone/html_tplmx/public/tcnotice.html";i:1629606714;s:64:"/www/wwwroot/video/template/mxone/html_tplmx/public/website.html";i:1650943918;s:58:"/www/wwwroot/video/template/mxone/html_tplmx/ads/addb.html";i:1629606708;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673c63255501a=explode(',',$maccms['search_hot']); if(is_array($_673c63255501a) || $_673c63255501a instanceof \think\Collection || $_673c63255501a instanceof \think\Paginator): if( count($_673c63255501a)==0 ) : echo "" ;else: foreach($_673c63255501a as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673c632554f36=explode(',',$maccms['search_hot']); if(is_array($_673c632554f36) || $_673c632554f36 instanceof \think\Collection || $_673c632554f36 instanceof \think\Paginator): if( count($_673c632554f36)==0 ) : echo "" ;else: foreach($_673c632554f36 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
					...
					<div class="mxone-pannel-box clearfix">
						...
						<div class="mxone-pannel_bd clearfix">
							<ul class="mxone-user__form col-pd clearfix">
								<p><span class="xiang active">所属会员组：</span><span class="text-red">[<?php echo $obj['group']['group_name']; ?>]</span></p>
								<p class="top-line-dot"><span class="xiang active">剩余仙豆：</span><span class="text-red">[<?php echo $obj['user_points']; ?>]</span></p>
								<p class="top-line-dot">
									<span class="xiang active">到期时间：</span>
									<span class="text-red">
										永久
										<!-- <?php if($obj['group_id'] < 3): ?>[无限期]<?php else: ?>[<?php echo mac_day($obj['user_end_time']); ?>]<?php endif; ?> -->
									</span>
								</p>									
							</ul>																							
						</div>								
						...
						<div class="mxone-pannel_bd clearfix">
							...
							<div class="mxone-pannel_bd clearfix">
								...
								<div class="col-md-4 col-sm-2 col-xs-2">
									<a class="grade btn btn-block btn-primary" href="javascript:;" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_permanent']; ?>" data-long="permanent" style="padding: 20px;">
										<p style="font-size: 18px;"><b><?php echo $vo['group_name']; ?></b></p>
										<p>永久：<?php echo $vo['group_points_permanent']; ?>仙豆</p>
										<p>推广佣金：<?php echo $vo['group_commission']; ?>%</p>
										<?php if($vo['group_id'] == 11): ?>
										<p>所有下线佣金：<?php echo $vo['group_commission_all']; ?>%</p>
										点击升级
										<?php else: ?>
										点击升级
										<p>&nbsp;</p>
								...
								<!-- <?php if(is_array($group_list) || $group_list instanceof \think\Collection || $group_list instanceof \think\Paginator): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if($vo['group_id'] > 2): ?>
								<div class="col-md-4 col-sm-2 col-xs-2">
									<a class="grade btn btn-block btn-primary" href="javascript:;" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_day']; ?>" data-long="day" style="padding: 20px;">
										<p style="font-size: 18px;"><b><?php echo $vo['group_name']; ?></b></p>
										<p>包天：<?php echo $vo['group_points_day']; ?>仙豆</p>
										点击升级
									</a>
								</div>
								<div class="col-md-4 col-sm-2 col-xs-2">
									<a class="grade btn btn-block btn-primary" href="javascript:;" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_week']; ?>" data-long="week" style="padding: 20px;">
									<p style="font-size: 18px;"><b><?php echo $vo['group_name']; ?></b></p>
									<p>包周：<?php echo $vo['group_points_week']; ?>仙豆</p>
									点击升级
									</a>
								</div>
								<div class="col-md-4 col-sm-2 col-xs-2">
									<a class="grade btn btn-block btn-primary" href="javascript:;" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_month']; ?>" data-long="month" style="padding: 20px;">
										<p style="font-size: 18px;"><b><?php echo $vo['group_name']; ?></b></p>
										<p>包月：<?php echo $vo['group_points_month']; ?>仙豆</p>
										点击升级
									</a>
								</div>
								<div class="col-md-4 col-sm-2 col-xs-2">
									<a class="grade btn btn-block btn-primary" href="javascript:;" data-id="<?php echo $vo['group_id']; ?>" data-name="<?php echo $vo['group_name']; ?>" data-points="<?php echo $vo['group_points_year']; ?>" data-long="year" style="padding: 20px;">
										<p style="font-size: 18px;"><b><?php echo $vo['group_name']; ?></b></p>
										<p>包年：<?php echo $vo['group_points_year']; ?>仙豆</p>
										点击升级
									</a>
								</div>
								<?php endif; endforeach; endif; else: echo "" ;endif; ?> -->
...
<script type="text/javascript">
		$('.grade').click(function(){
			...
			if(confirm('确定要升级到【'+group_name+'】吗,需要花费【'+points+'】仙豆')) {
				$.ajax({
