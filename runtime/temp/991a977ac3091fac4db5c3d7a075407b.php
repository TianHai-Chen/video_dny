					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_6736c10fd9af4=explode(',',$maccms['search_hot']); if(is_array($_6736c10fd9af4) || $_6736c10fd9af4 instanceof \think\Collection || $_6736c10fd9af4 instanceof \think\Paginator): if( count($_6736c10fd9af4)==0 ) : echo "" ;else: foreach($_6736c10fd9af4 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_6736c10fd99b7=explode(',',$maccms['search_hot']); if(is_array($_6736c10fd99b7) || $_6736c10fd99b7 instanceof \think\Collection || $_6736c10fd99b7 instanceof \think\Paginator): if( count($_6736c10fd99b7)==0 ) : echo "" ;else: foreach($_6736c10fd99b7 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
							...
							<form method="post" target="_blank" action="<?php echo url('user/gopay'); ?>">
								...
								<div class="mxone-user__form col-pd clearfix">
									...
									<p class="top-line-dot"><span class="xiang active">订单金额：</span>
										<b class="text-red"><?php echo $info['order_price']; ?>元</b>
									</p>
									<p class="top-line-dot"><span class="xiang active">支付方式：</span>
										<select name="payment" id="payment">
											<option value ="">请选择...</option>
											<?php if($config['zhifubao']['appid'] != ''): ?>
											<option value ="zhifubao">waf支付</option>
											<?php endif; ?>
											<!-- <?php if($config['alipay']['appid'] != ''): ?>
											<option value ="alipay">支付宝支付</option>
											<?php endif; ?> -->
											<?php if($config['weixin']['appid'] != ''): ?>
											<option value="weixin">微信支付</option>
											<?php endif; if($config['codepay']['appid'] != ''): ?>
											<option value="codepay">码支付</option>
											<?php endif; if($config['zhapay']['appid'] != ''): ?>
...
<script>
	var codepay_type = '<?php $_6736c10fd9068=explode(',',$config['codepay']['type']); if(is_array($_6736c10fd9068) || $_6736c10fd9068 instanceof \think\Collection || $_6736c10fd9068 instanceof \think\Paginator): if( count($_6736c10fd9068)==0 ) : echo "" ;else: foreach($_6736c10fd9068 as $key=>$vo): ?><option value ="<?php echo $vo; ?>"><?php if($vo==1): ?>支付宝二维码<?php elseif($vo==2): ?>QQ钱包二维<?php elseif($vo==3): ?>微信二维码<?php endif; ?></option><?php endforeach; endif; else: echo "" ;endif; ?>';
	var zhapay_type ='<?php $_6736c10fd8ff9=explode(',',$config['zhapay']['type']); if(is_array($_6736c10fd8ff9) || $_6736c10fd8ff9 instanceof \think\Collection || $_6736c10fd8ff9 instanceof \think\Paginator): if( count($_6736c10fd8ff9)==0 ) : echo "" ;else: foreach($_6736c10fd8ff9 as $key=>$vo): ?><option value ="<?php echo $vo; ?>"><?php if($vo==1): ?>微信<?php elseif($vo==2): ?>支付宝<?php endif; ?></option> <?php endforeach; endif; else: echo "" ;endif; ?>';
