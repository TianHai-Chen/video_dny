<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpstudy_pro\WWW\video1/application/admin\view\system\configplay.html";i:1638283348;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" action="">
        <div class="layui-tab">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">上方LOGO图：</label>
                    <div class="layui-input-block">
                        <input type="text" name="play[app_logo]" placeholder="不要出现双引号、单引号等特殊字符号" value="<?php echo $play['app_logo']; ?>" class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item">
...
<script type="text/javascript">
    ...
    layui.use(['form', 'layer'], function(){
        ...
        $('#btnDef').click(function(){
            ...
            $('input[name="play[prestrain]"]').val('//union.lvdoui.cn/html/prestrain.html');
            $('input[name="play[buffer]"]').val('//union.lvdoui.cn/html/buffer.html');
            $('input[name="play[parse]"]').val('//api.lvdoui.cn/parse/?url=');
