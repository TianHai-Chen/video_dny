					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673c58ad3a52b=explode(',',$maccms['search_hot']); if(is_array($_673c58ad3a52b) || $_673c58ad3a52b instanceof \think\Collection || $_673c58ad3a52b instanceof \think\Paginator): if( count($_673c58ad3a52b)==0 ) : echo "" ;else: foreach($_673c58ad3a52b as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673c58ad3a3df=explode(',',$maccms['search_hot']); if(is_array($_673c58ad3a3df) || $_673c58ad3a3df instanceof \think\Collection || $_673c58ad3a3df instanceof \think\Paginator): if( count($_673c58ad3a3df)==0 ) : echo "" ;else: foreach($_673c58ad3a3df as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
					...
					<div class="mxone-pannel_bd clearfix">
						...
						<div class="mxone-pannel_bd clearfix">
							<div class="mxone-user__form col-pd clearfix">
								<p><span class="xiang active">剩余仙豆：</span><span class="text-red"><?php echo $obj['user_points']; ?></span></p>
								<!-- <p class="top-line-dot"><span class="xiang">充值的金额：</span><input type="text" name="price" value="<?php echo $config['min']; ?>" class="form-control" placeholder="充值金额"></p>
								<p class="top-line-dot"><span class="xiang"></span><input type="button" id="btn_submit_pay" class="btn btn-primary" value="确认"></p>
								<p class="top-line-dot"><span class="xiang">友情提示：</span><span class="text-muted">最小充值金额为<?php echo $config['min']; ?>元，1元可以兑换<?php echo $config['scale']; ?>个仙豆</span></p> -->
							</div>																							
						</div>		
					</div>
				</div>
					...
					<div class="mxone-pannel_bd clearfix">
						...
						<div class="mxone-pannel_bd clearfix">
							<div class="mxone-user__form col-pd clearfix">
								...
								<p class="top-line-dot"><span class="xiang">友情提示：</span><span class="text-muted">请到卡密平台购买充值卡，最小充值金额为<?php echo $config['min']; ?>元，1元可以兑换<?php echo $config['scale']; ?>个仙豆</span></p>
...
<script>
	...
	$('#btn_submit_withdrawal').click(function(){
		...
		if(confirm('确定要提现吗')) {
			$.ajax({
				url: "<?php echo url('user/withdraw'); ?>",
				type: "post",
				dataType: "json",
