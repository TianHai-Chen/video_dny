<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\phpstudy_pro\WWW\video1/application/admin\view\index\welcome.html";i:1663860384;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container">
    ...
    <blockquote class="layui-elem-quote layui-quote-nm mt10">
        <p>上次登录IP：<?php echo long2ip($info['admin_last_login_ip']); ?> 上次登录时间：<?php echo mac_day($info['admin_last_login_time']); ?></p><br>
        <p>你好陌生人：愿你三冬暖、愿你春不寒、愿你天黑有灯、下雨有伞、愿你路上有良人相伴~</p><br>
    </blockquote>
    ...
    <table class="layui-table" >
        ...
        <tr>
            <td colspan="4">当前版本：<span class="layui-badge">20220209</span> 授权类型：<span class="layui-badge">APP官方版</span></td>
	...
	<!--JS显示提示-->
	<span id="xz_upgrade_check"></span>
	<a class="layui-btn layui-btn-danger layui-btn-sm" id="xz_upgrade_check_btn" href="https://jq.qq.com/?_wv=1027&k=1pz7rG6d" target="_blank">点击链接加入群聊【售后交流群】</a>
	</blockquote>
</div>
<script>
</script>
