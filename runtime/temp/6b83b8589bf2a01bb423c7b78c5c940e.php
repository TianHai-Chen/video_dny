<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:42:"template/mxone/html_tplmx/vod/confirm.html";i:1731729505;s:64:"/www/wwwroot/video/template/mxone/html_tplmx/public/include.html";i:1629606714;s:58:"/www/wwwroot/video/template/mxone/html_tplmx/ads/adqj.html";i:1629606708;s:61:"/www/wwwroot/video/template/mxone/html_tplmx/public/head.html";i:1731557950;s:61:"/www/wwwroot/video/template/mxone/html_tplmx/public/foot.html";i:1629606736;s:65:"/www/wwwroot/video/template/mxone/html_tplmx/public/tcnotice.html";i:1629606714;s:64:"/www/wwwroot/video/template/mxone/html_tplmx/public/website.html";i:1650943918;s:58:"/www/wwwroot/video/template/mxone/html_tplmx/ads/addb.html";i:1629606708;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
	<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<title>使用仙豆购买权限</title>
					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673c6b278d536=explode(',',$maccms['search_hot']); if(is_array($_673c6b278d536) || $_673c6b278d536 instanceof \think\Collection || $_673c6b278d536 instanceof \think\Paginator): if( count($_673c6b278d536)==0 ) : echo "" ;else: foreach($_673c6b278d536 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673c6b278d465=explode(',',$maccms['search_hot']); if(is_array($_673c6b278d465) || $_673c6b278d465 instanceof \think\Collection || $_673c6b278d465 instanceof \think\Paginator): if( count($_673c6b278d465)==0 ) : echo "" ;else: foreach($_673c6b278d465 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
...
<div class="mx-mac_msg_jump">
	...
	<div class="text">
		<?php echo $popedom['msg']; ?>
		<p class="text-muted" style="font-size: 10px;margin-bottom: 10px;">提示：一次支付，永久观看，不重复扣费，谢谢支持。</p>
		<p style="text-align:center;">
			<?php if($user['group']['group_id'] == 1): ?>
			<a href="javascript:;" class="mac_user btnlogin" target="_blank">马上登录</a>
			<?php else: ?>
			<a href="<?php echo url('user/buy'); ?>" class="btncz" target="_blank">马上充值</a>
			<a href="javascript:;" onclick="MAC.User.BuyPopedom(this)" class="btnlogin" data-id="<?php echo $obj['vod_id']; ?>" data-sid="<?php echo $param['sid']; ?>" data-nid="<?php echo $param['nid']; ?>" data-mid="1" data-type="<?php if($obj['player_info']['flag'] == 'play'): ?>4<?php else: ?>5<?php endif; ?>" data-mid="1">确认购买</a>
			<?php endif; ?>
		</p>
	</div>
</div>
