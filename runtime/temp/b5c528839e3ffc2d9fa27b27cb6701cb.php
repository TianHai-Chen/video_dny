<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:58:"/www/wwwroot/video/application/admin/view/index/login.html";i:1644122248;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="login-head">
    <h1><a href="http://app.maccms.ren/">苹果CMS一路陪伴，感恩有你！</a></h1>
</div>
<div class="login-box">
    ...
    <div class="copyright">
        © 2008-2019 <a href="http://app.maccms.ren" target="_blank">app.maccms.ren</a> All Rights Reserved.
    </div>
</div>
