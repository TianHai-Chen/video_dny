<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:65:"D:\phpstudy_pro\WWW\video1/application/admin\view\group\info.html";i:1731729505;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <form class="layui-form layui-form-pane" method="post" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" value="<?php echo $info['group_points_permanent']; ?>" placeholder="永久" lay-verify="group_points_permanent" name="group_points_permanent">
                <span>豆</span> 
            </div>
        </div>
        <style type="text/css">
            .layui-input-inline span {
                position: absolute; /* 或者使用其他定位方式，取决于你的布局需求 */
                right: 8px; /* 调整这个值以改变百分号与输入框右边的距离 */
                top: 50%; /* 垂直居中，可能需要transform来微调 */
                transform: translateY(-50%);
                font-size: 16px; /* 或者其他你想要的字体大小 */
            }
        </style>
        <div class="layui-form-item">
            <label class="layui-form-label">推广佣金：</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" value="<?php echo $info['group_commission']; ?>" placeholder="推广佣金：" lay-verify="group_commission" name="group_commission">
                <span>%</span> 
            </div>
            <label class="layui-form-label">所有下线佣金：</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" value="<?php echo $info['group_commission_all']; ?>" placeholder="所有下线佣金" lay-verify="group_commission_all" name="group_commission_all">
                <span>%</span>
            </div>
        </div>
        <!-- <div class="layui-form-item">
        ...
        <div class="layui-form-item ">
            ...
            <div class="layui-input-block">
                <blockquote class="layui-elem-quote layui-quote-nm">
                    ...
                    2.试看权限：如果没有访问播放页的权限、或者有权限但是需要仙豆购买的数据，开启了试看权限也是可以进入页面的。
                </blockquote>
