					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673ab2e256e43=explode(',',$maccms['search_hot']); if(is_array($_673ab2e256e43) || $_673ab2e256e43 instanceof \think\Collection || $_673ab2e256e43 instanceof \think\Paginator): if( count($_673ab2e256e43)==0 ) : echo "" ;else: foreach($_673ab2e256e43 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673ab2e256cf9=explode(',',$maccms['search_hot']); if(is_array($_673ab2e256cf9) || $_673ab2e256cf9 instanceof \think\Collection || $_673ab2e256cf9 instanceof \think\Paginator): if( count($_673ab2e256cf9)==0 ) : echo "" ;else: foreach($_673ab2e256cf9 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
							 ...
							 <form id="form1" name="form1" method="post">
								<ul class="mxone-vodlist__text striped to-color col-pd clearfix">
									<li class="striped-head clearfix">
										...
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs">消耗仙豆</span>
										<span class="col-md-wide-10 col-sm-wide-10 col-xs-wide-3 text-right">操作</span>
									</li>
									<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<li class="clearfix">										
										<span class="col-md-wide-10 col-sm-wide-10 col-xs-wide-15"><input type="checkbox" name="ids[]" id="checkbox" class="checkboxinput" value="<?php echo $vo['ulog_id']; ?>"/></span>
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs"><?php echo $vo['ulog_id']; ?></span>
										...
										<span class="col-md-wide-10 hidden-sm hidden-xs"><a target="_blank" href="<?php echo $vo['data']['link']; ?>" class="fen">重新下载</a></span>
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs"><?php echo $vo['ulog_points']; ?></span>
										<span class="col-md-wide-10 col-sm-wide-10 col-xs-wide-3 text-right">
											<a href="javascript:;" onclick="delData(<?php echo $vo['ulog_id']; ?>,0)" class="delete">删除</a>
										</span>																			
									</li>
				  					<?php endforeach; endif; else: echo "" ;endif; ?>
