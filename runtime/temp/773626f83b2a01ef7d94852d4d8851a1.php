<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\phpstudy_pro\WWW\video1/application/admin\view\cj\info.html";i:1568100986;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <div class="layui-tab layui-tab-card" style="min-height: 430px;">
                    ...
                    <div class="layui-tab-content">
                        ...
                        <div class="layui-tab-item layui-show">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block" style="width: 60%">
                                    <input type="text" name="data[name]" placeholder="请输入" value="<?php echo $data['name']; ?>" class="layui-input">
                                </div>
                            </div>
                            <div class="layui-form-item">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="data[mid]" value="1" title="视频" <?php if($data['mid'] != '2'): ?>checked='checked'<?php endif; ?>>
                                    <input type="radio" name="data[mid]" value="2" title="文章" <?php if($data['mid'] == '2'): ?>checked='checked'<?php endif; ?>>
                                </div>
                            </div>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="radio" name="data[sourcetype]" id="_1" value="1" lay-filter="sourcetype" title="序列网址" <?php if($data['sourcetype'] == 1): ?>checked='checked'<?php endif; ?>>
                                    <input type="radio" name="data[sourcetype]" id="_2" value="2" lay-filter="sourcetype" title="多个网页" <?php if($data['sourcetype'] == 2): ?>checked='checked'<?php endif; ?>>
                                    <input type="radio" name="data[sourcetype]" id="_3" value="3" lay-filter="sourcetype" title="单一网页" <?php if($data['sourcetype'] == 3): ?>checked='checked'<?php endif; ?>>
                                </div>
                            </div>
                            ...
                            <div class="layui-collapse" lay-filter="lay_state" style="margin: 20px 0;">
                                ...
                                <div class="layui-colla-item">
                                    ...
                                    <div class="layui-colla-item">
                                        ...
                                        <div class="layui-colla-content layui-show">
                                            <div class="layui-form-item">
                                                <input type="radio" name="data[content_page_rule]" id="_1" value="1" title="全部列出模式" lay-filter="content_page_rule" <?php if($data['content_page_rule'] != 2): ?>checked="checked"<?php endif; ?>>
                                                <input type="radio" name="data[content_page_rule]" id="_2" value="2" title="上下页模式" lay-filter="content_page_rule" <?php if($data['content_page_rule'] == 2): ?>checked="checked"<?php endif; ?>>
                                            </div>
                                            ...
                                            <div class="layui-form-item">
                                                <label class="layui-form-label">匹配规则：</label>
                                                从 <textarea rows="5" cols="40" name="data[content_page_start]" id="content_page_start"><?php echo $data['content_page_start']; ?></textarea> 到 <textarea rows="5" cols="40" name="data[content_page_end]" id="content_page_end"><?php echo $data['content_page_end']; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                            </div>
                        ...
                        <div class="layui-tab-item" id="customize_config">
                            ...
                            <div class="layui-form-item mt10"><label class="layui-form-label">规则名称：</label><div class="layui-input-inline"><input type="text" name="data[customize_config][name][]" placeholder="请输入" value="<?php echo $vo['name']; ?>" class="layui-input"></div><div class="layui-form-mid">规则英文名：</div><div class="layui-input-inline"><input type="text" name="data[customize_config][en_name][]" placeholder="请输入" value="<?php echo $vo['en_name']; ?>" class="layui-input"></div></div><div class="layui-form-item"><label class="layui-form-label">匹配规则：</label><div class="layui-input-inline"><textarea name="data[customize_config][rule][]" id="role_'+caiji+'" class="layui-textarea"><?php echo $vo['rule']; ?></textarea><div class="layui-form-mid layui-word-aux">使用"<a href="javascript:insertText(\'title_rule\', \'[内容]\')"> [内容] </a>"作为通配符    </div></div><div class="layui-form-mid">过滤规则：</div><div class="layui-input-inline"><textarea name="data[customize_config][html_rule][]" id="content_html_rule_'+caiji+'" class="layui-textarea"><?php echo $vo['html_rule']; ?></textarea><div class="layui-form-mid layui-word-aux"><a class="layui-btn layui-btn-xs" href="javascript:;" onclick="add_tag(\'content_html_rule_'+caiji+'\')">选择</a></div></div></div><hr>
