					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673af5f442bc6=explode(',',$maccms['search_hot']); if(is_array($_673af5f442bc6) || $_673af5f442bc6 instanceof \think\Collection || $_673af5f442bc6 instanceof \think\Paginator): if( count($_673af5f442bc6)==0 ) : echo "" ;else: foreach($_673af5f442bc6 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673af5f442a86=explode(',',$maccms['search_hot']); if(is_array($_673af5f442a86) || $_673af5f442a86 instanceof \think\Collection || $_673af5f442a86 instanceof \think\Paginator): if( count($_673af5f442a86)==0 ) : echo "" ;else: foreach($_673af5f442a86 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
				...
				<ul class="input-list">				
					<form method="post" id="fm" action="">					
						...
						<li class="text-center">
							<a href="<?php echo $maccms['path']; ?>">返回首页</a><span class="split-line"></span><a href="<?php echo url('user/login'); ?>">登录账号</a><span class="split-line"></span><a href="<?php echo url('user/findpass'); ?>">找回密码</a>
						</li>
					</form>
				</ul>			
			</div>
