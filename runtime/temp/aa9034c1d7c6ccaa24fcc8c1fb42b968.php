<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:65:"D:\phpstudy_pro\WWW\video1/application/admin\view\mycj\index.html";i:1727744400;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
  ...
  <div class="layui-row">
    ...
    <div class="layui-header">
		<ul class="layui-nav layui-hide-xs mycj-header">
		  ...
		  <li class="layui-nav-item layuiBtn" data-type="feedback">
		...
		<ul class="layui-nav layui-layout-right">
		  <li class="layui-nav-item"> 
			<a href="javascript:;"><img src="/static/mycj/pro_icon.png"> <?php echo $cjinfo['version']; ?></a>
			<dl class="layui-nav-child">
			  <dd><a href="javascript:;" class="layuiBtn" data-type="update"><i class="layui-icon layui-icon-refresh"></i> 检查更新</a></dd>	
			  <dd><a href="javascript:;" class="layuiBtn" data-type="uninstall"><i class="layui-icon layui-icon-delete"></i> 卸载插件</a></dd>
			  <dd><a href="javascript:;" class="layuiBtn" data-type="feedback"><i class="layui-icon layui-icon-reply-fill"></i> 建议反馈</a></dd>
...
<script type="text/javascript" src="/static/mycj/js/index.js?v=<?php echo $cjinfo['version']; ?>"></script>
</body>
</html>