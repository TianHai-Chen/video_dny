<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"D:\phpstudy_pro\WWW\video1/application/admin\view\system\configuser.html";i:1731901256;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux">用户注册成功后默认赠送仙豆</div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label">邀请注册仙豆：</label>
                    <div class="layui-input-inline w150">
                        <input type="text" name="user[invite_reg_points]" placeholder="" value="<?php echo $config['user']['invite_reg_points']; ?>" class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">成功邀请用户赚取奖励仙豆</div>
                </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">推广访问仙豆：</label>
                        <div class="layui-input-inline w150">
                        ...
                        <div class="layui-form-mid layui-word-aux">成功邀请访问赚取奖励仙豆</div>
                        <label class="layui-form-label">每IP限制：</label>
                        <div class="layui-input-inline w150">
                            <input type="text" name="user[invite_visit_num]" placeholder="" value="<?php echo $config['user']['invite_visit_num']; ?>" class="layui-input">
                        </div>
                        <div class="layui-form-mid layui-word-aux">每个IP每日限制可以获取几次推广访问仙豆</div>
                    </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux">用户支付成功分销推广者都可获得一定比例的仙豆。提成不足1仙豆将忽略。</div>
                    </div>
                    ...
                    <div class="layui-form-item layui-hide">
                        ...
                        <div class="layui-input-inline w150">
                            <input type="text" name="user[cash_ratio]" placeholder="兑换比例1元=多少仙豆" value="<?php echo $config['user']['cash_ratio']; ?>" class="layui-input">
                        </div>
                        <div class="layui-form-mid layui-word-aux">兑换比例1元=多少仙豆</div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux">全局设置无权限需要仙豆点播的试看时长，单位分钟；0表示关闭全局试看；</div>
                    </div>
                    <div class="layui-form-item">
                        ...
                        <div class="layui-form-mid layui-word-aux">全局设置点播仙豆</div>
                    </div>
                    <div class="layui-form-item">
