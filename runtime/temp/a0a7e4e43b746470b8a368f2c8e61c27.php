<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:64:"D:\phpstudy_pro\WWW\video1/application/admin\view\user\info.html";i:1731729505;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<div class="page-container p10">
    ...
    <form class="layui-form layui-form-pane" method="post" action="">
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">是否为代理商：</label>
            <div class="layui-input-block">
                <input name="is_agents" type="radio" id="rad-3" value="0" title="否" <?php if($info['is_agents'] != 1): ?>checked <?php endif; ?>>
                <input name="is_agents" type="radio" id="rad-4" value="1" title="是" <?php if($info['is_agents'] == 1): ?>checked <?php endif; ?>>
            </div>
        </div>
        ...
        <div class="layui-form-item" >
            ...
            <div class="layui-input-inline">
                <input type="text" class="layui-input" value="<?php echo $info['user_gold']; ?>" placeholder="" id="user_gold" name="user_gold">
            </div>
            <label class="layui-form-label">剩余次数：</label>
            <div class="layui-input-inline">
                <input type="text" class="layui-input" value="<?php echo $info['view_times']; ?>" placeholder="" id="view_times" name="view_times">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">仙豆：</label>
            <div class="layui-input-inline">
