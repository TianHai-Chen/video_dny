<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"D:\phpstudy_pro\WWW\video1/application/admin\view\system\config.html";i:1638428474;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="site[site_url]" placeholder="如：www.lvdoui.cn,不要加http://" value="<?php echo $config['site']['site_url']; ?>" class="layui-input">
                    </div>
                </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">手机站域名：</label>
                        <div class="layui-input-block">
                            <input type="text" name="site[site_wapurl]" placeholder="如：www.lvdoui.cn,不要加http://" value="<?php echo $config['site']['site_wapurl']; ?>" class="layui-input">
                        </div>
                    </div>
                <div class="layui-form-item">
                ...
                <div class="layui-tab-item">
                    ...
                    <div class="layui-form-item">
                        <label class="layui-form-label">锁定目录权限：</label>
                        <div class="layui-input-inline w150">
                            <select class="w150" name="app[lock_dir]">
                                <option value="0" <?php if($config['app']['lock_dir'] == '0'): ?>selected <?php endif; ?>>关闭</option>
                                <option value="1" <?php if($config['app']['lock_dir'] == '1'): ?>selected <?php endif; ?>>锁定应用目录</option>
                                <option value="2" <?php if($config['app']['lock_dir'] == '2'): ?>selected <?php endif; ?>>锁定应用及缓存</option>
                            </select>
                        </div>
                        <div class="layui-form-mid layui-word-aux">锁定权限可防止文件被恶意修改！开启缓存锁定将无法缓存页面</div>
                    </div>
