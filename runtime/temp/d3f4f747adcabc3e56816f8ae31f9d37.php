					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_6735b48d7dc82=explode(',',$maccms['search_hot']); if(is_array($_6735b48d7dc82) || $_6735b48d7dc82 instanceof \think\Collection || $_6735b48d7dc82 instanceof \think\Paginator): if( count($_6735b48d7dc82)==0 ) : echo "" ;else: foreach($_6735b48d7dc82 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_6735b48d7dadb=explode(',',$maccms['search_hot']); if(is_array($_6735b48d7dadb) || $_6735b48d7dadb instanceof \think\Collection || $_6735b48d7dadb instanceof \think\Paginator): if( count($_6735b48d7dadb)==0 ) : echo "" ;else: foreach($_6735b48d7dadb as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
					...
					<div class="mxone-pannel_bd clearfix">
						<div class="mxone-pannel_hd">
							<div class="mxone-pannel__head active bottom-line clearfix">
								<a class="more text-red pull-right nonemore" href="javascript:;" id="btnClear">清空记录</a>
								<h3 class="title">
									播放记录
								</h3>
							</div>																		
							 ...
							 <form id="form1" name="form1" method="post">
								<ul class="mxone-vodlist__text striped to-color col-pd clearfix">
									<li class="striped-head clearfix">
										...
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs text-center">消耗仙豆</span>
										<span class="col-md-wide-10 col-sm-wide-10 col-xs-wide-3 text-right">操作</span>
									</li>
									<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
									<li class="clearfix">										
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs"><input type="checkbox" name="ids[]" id="checkbox" class="checkboxinput" value="<?php echo $vo['ulog_id']; ?>"/></span>
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs text-muted"><?php echo $vo['ulog_id']; ?></span>
										...
										<span class="col-md-wide-10 hidden-sm hidden-xs text-center"><a target="_blank" href="<?php echo $vo['data']['link']; ?>" class="fen">重新观看</a></span>
										<span class="col-md-wide-10 col-sm-wide-10 hidden-xs text-center"><?php if($vo['ulog_points'] == 0): ?>免费<?php else: ?><?php echo $vo['ulog_points']; endif; ?></span>
										<span class="col-md-wide-10 col-sm-wide-10 col-xs-wide-3 text-right">
											<a class="text-red" href="javascript:;" onclick="delData(<?php echo $vo['ulog_id']; ?>,0)" class="delete">删除</a>
										</span>																			
									</li>
				  					<?php endforeach; endif; else: echo "" ;endif; ?>
