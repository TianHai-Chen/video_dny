					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673d5630aa2c2=explode(',',$maccms['search_hot']); if(is_array($_673d5630aa2c2) || $_673d5630aa2c2 instanceof \think\Collection || $_673d5630aa2c2 instanceof \think\Paginator): if( count($_673d5630aa2c2)==0 ) : echo "" ;else: foreach($_673d5630aa2c2 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673d5630aa1a4=explode(',',$maccms['search_hot']); if(is_array($_673d5630aa1a4) || $_673d5630aa1a4 instanceof \think\Collection || $_673d5630aa1a4 instanceof \think\Paginator): if( count($_673d5630aa1a4)==0 ) : echo "" ;else: foreach($_673d5630aa1a4 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
...
<script>
	...
	$(".face").on("imageUpload.uploadFailed", function (ev, err) {
    	...
    	<div class="col-md-wide-75 col-sm-wide-65 col-xs-1 mxone-pannel-side hidden-xs" >   		
    		<div class="mxone-pannel mxone-pannel-bg clearfix">
				<div class="mxone-pannel-box clearfix">
					...
					<div class="mxone-pannel_bd clearfix">
						<ul class="mxone-user__form col-pd clearfix">
							...
							<p class="top-line-dot"><span class="xiang">QQ号码：</span><?php echo mac_default($obj['user_qq'],'未填写'); ?></p>
							<p class="top-line-dot"><span class="xiang">Email地址：</span><?php echo $obj['user_email']; ?></p>
							<p class="top-line-dot"><span class="xiang">注册时间：</span><?php echo mac_day($obj['user_reg_time']); ?></p>
							<p class="top-line-dot"><span class="xiang">登陆IP：</span><?php echo long2ip($obj['user_login_ip']); ?></p>
							<p class="top-line-dot"><span class="xiang">登陆时间：</span><?php echo mac_day($obj['user_login_time']); ?></p>
							<p class="top-line-dot hidden-sm"><span class="xiang">推广链接：</span><a class="urlcopy" href="javascript:;" data-clipboard-text="http://<?php echo $maccms['site_url']; ?><?php echo mac_url('user/reg'); ?>?uid=<?php echo $obj['user_id']; ?>">http://<?php echo $maccms['site_url']; ?><?php echo mac_url('user/reg'); ?>?uid=<?php echo $obj['user_id']; ?></a>
							</p>
						</ul>																							
					</div>		
				</div>
			...
			<div class="mxone-pannel mxone-pannel-bg clearfix">	
				<div class="mxone-pannel-box">
	                ...
	                <?php $__TAG__ = '{"type":"all","order":"desc","by":"hts","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;if($mxonest['mxcms']['s2']['qzslt'] == 1): ?>	    
	                 	<div class="module-item module-item-go w16">
					<div class="module-item-cover">
						<div class="module-item-pic">
							<a href="<?php if($mxonest['mxcms']['s2']['tzzt'] == 1): ?><?php echo mac_url_vod_play($vo); else: ?><?php echo mac_url_vod_detail($vo); endif; ?>" title="<?php echo $vo['vod_name']; ?>"></a><img class=" ls-is-cached  lazy lazyloaded" data-src="<?php echo mac_url_img($vo['vod_pic']); ?>" src="<?php echo mac_url_img($mxonest['mxcms']['s1']['pic1']); ?>" alt="<?php echo $vo['vod_name']; ?>">
				...
				<?php else: ?>
	             <div class="module-item width165">
				<div class="module-item-cover">
					<div class="module-item-pic">
