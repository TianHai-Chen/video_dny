<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:63:"D:\phpstudy_pro\WWW\video1/application/admin\view\vod\info.html";i:1732007607;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\head.html";i:1731557514;s:66:"D:\phpstudy_pro\WWW\video1\application\admin\view\public\foot.html";i:1568100986;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline w150">
                            <select name="vod_level">
                                ...
                                <option value="5" <?php if($info['vod_level'] == 5): ?>selected<?php endif; ?>>推荐5-首页猜你喜欢</option>
                                ...
                                <option value="8" <?php if($info['vod_level'] == 8): ?>selected<?php endif; ?>>推荐8-分类幻灯片</option>
                                <option value="9" <?php if($info['vod_level'] == 9): ?>selected<?php endif; ?>>推荐9-首页幻灯片</option>
                            </select>
                    </div>
                ...
                <div class="layui-form-item ">
                    ...
                    <div class="layui-input-inline ">
                        <input type="text" class="layui-input" value="<?php echo $info['vod_sub']; ?>" placeholder="" name="vod_title" id="vod_title">
                    </div>
                    <div class="layui-input-inline">
                        <select name="vod_is_member">
                            <option value="0" <?php if($info['vod_is_member'] == '0'): ?>selected<?php endif; ?>>免费</option>
                            <option value="1" <?php if($info['vod_is_member'] == '1'): ?>selected<?php endif; ?>>需要会员</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline w500">
                            <input type="text" class="layui-input" value="<?php echo $info['vod_custom_tag']; ?>" placeholder="" name="vod_custom_tag" id="vod_remarks">
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline w500">
                            <input type="text" class="layui-input" value="<?php echo $info['vod_states']; ?>" placeholder="" id="vod_state" name="vod_state">
                        </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                            <textarea id="vod_content" name="vod_content" type="text/plain" style="width:99%;height:250px"><?php echo $info['vod_content']; ?></textarea>
                        </div>
                    </div>
        </div>
