					...
					<div class="search-drop">
						<div class="drop-content-items ac_hot none">
							...
							<div class="search-tag">
								<?php $_673c5b34771f4=explode(',',$maccms['search_hot']); if(is_array($_673c5b34771f4) || $_673c5b34771f4 instanceof \think\Collection || $_673c5b34771f4 instanceof \think\Paginator): if( count($_673c5b34771f4)==0 ) : echo "" ;else: foreach($_673c5b34771f4 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_673c5b3477055=explode(',',$maccms['search_hot']); if(is_array($_673c5b3477055) || $_673c5b3477055 instanceof \think\Collection || $_673c5b3477055 instanceof \think\Paginator): if( count($_673c5b3477055)==0 ) : echo "" ;else: foreach($_673c5b3477055 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
