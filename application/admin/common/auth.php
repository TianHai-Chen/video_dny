...
return array(
    ...
    '2' => array('name' => '系统', 'icon' => 'xe62e', 'sub' => array(
        ...
        '23' => array("show"=>1,"name" => '播放框架配置', 'controller' => 'system',			'action' => 'configplay'),
    ...
    '4' => array('name' => '视频', 'icon' => 'xe639', 'sub' => array(
        ...
        '481' => array("show"=>1,'name' => '需仙豆视频', 'controller' => 'vod',		'action' => 'data', 'param'=>'points=1'),
        ...
        '41' => array("show"=>1,'name' => '服务器组配置', 'controller' => 'vodserver',		'action' => 'index'),
        ...
        '43' => array("show"=>1,'name' => '下载器配置', 'controller' => 'voddowner',		'action' => 'index'),
        ...
        '495' => array("show"=>1,'name' => '演员库列表', 'controller' => 'actor',		'action' => 'data', 'param'=>''),
    ...
    '6' => array('name' => '用户', 'icon' => 'xe62c', 'sub' => array(
        '61' => array("show"=>1,'name' => '管理设置', 'controller' => 'admin',		'action' => 'index'),
        ...
        '62' => array("show"=>1,'name' => '权限设置', 'controller' => 'group',		'action' => 'index'),
        ...
        '63' => array("show"=>1,'name' => '用户中心', 'controller' => 'user',		'action' => 'data'),
    ...
    '7' => array('name' => '模版', 'icon' => 'xe72d', 'sub' => array(
        ...
        '72' => array("show"=>1,'name' => '广告管理', 'controller' => 'template',		'action' => 'ads',  'param'=>''),
    ...
    '10' => array('name' => lang('数据库'), 'icon' => 'xe621', 'sub' => array(
        '101' => array("show"=>1,'name' => lang('数据库管理'), 'controller' => 'database',		'action' => 'index'),
        ...
        '102' => array("show"=>1,'name' => lang('执行SQL语句'), 'controller' => 'database',		'action' => 'sql'),
        '103' => array("show"=>1,'name' => lang('数据库批量替换'), 'controller' => 'database',		'action' => 'rep'),
    )),
		'12' => array('name' => 'APP设置', 'icon' => 'xe622', 'sub' => array(
        '121' => array("show"=>1,"name" => '基本设置', 'controller' => 'system',			'action' => 'configuser'),
        '122' => array("show"=>1,"name" => '短信配置', 'controller' => 'system',			'action' => 'configsms'),
        '123' => array("show"=>1,"name" => '弹窗配置', 'controller' => 'system',			'action' => 'configapppopupwindow'),
        '124' => array("show"=>1,"name" => '任务中心', 'controller' => 'system',			'action' => 'configtaskarticle'),
        '125' => array("show"=>1,"name" => '版本管理', 'controller' => 'appversion',			'action' => 'index'),
        '126' => array("show"=>1,"name" => '基础广告', 'controller' => 'appsetting',			'action' => 'index'),
		'28' => array("show"=>1,"name" => '支付配置', 'controller' => 'system',			'action' => 'configpay'),
		'127' => array("show"=>1,'name' => '全局广告', 'controller' => 'adtype',		'action' => 'index'),
        '1271' => array("show"=>0,'name' => '--广告类型息维护', 'controller' => 'adtype',		'action' => 'info'),
        '1272' => array("show"=>0,'name' => '--广告类型删除', 'controller' => 'adtype',		'action' => 'del'),
        '1273' => array("show"=>0,'name' => '--广告类型状态', 'controller' => 'adtype',		'action' => 'field'),
		'128' => array("show"=>1,'name' => '直播管理', 'controller' => 'zhibo',		'action' => 'index'),
        '129' => array("show"=>1,'name' => '游戏管理', 'controller' => 'youxi',		'action' => 'index'),
        ...
        '398' => array("show"=>1,'name' => '自定义跳转', 'controller' => 'groupchat',		'action' => 'index'),
        ...
        '39' => array("show"=>1,'name' => '弹幕管理', 'controller' => 'danmu',		'action' => 'data'),
        '1125' => array("show"=>1,"name" => '魔改二开设置', 'controller' => 'admin', 'action' => 'lock'),    
    )),
