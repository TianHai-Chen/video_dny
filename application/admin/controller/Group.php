...
class Group extends Base
{
    ...
    public function index()
    {
        ...
        $this->assign('userAgentsScore',Config::get('score.agents_score'));
    ...
    public function field()
    {
     ...
     public function agentsScore()
    {
        $param = input();
        $score = $param['user_agents_score'];

        $fileurl = APP_PATH . "extra/score.php";
        $score_config = <<<INFO
<?php
    return ['agents_score'=>$score];
INFO;
        file_put_contents($fileurl,$score_config);
