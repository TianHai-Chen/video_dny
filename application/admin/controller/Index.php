...
class Index extends Base
{
    ...
    public function welcome()
    {
        ...
        echo $html.'<span style="display:none"><iframe src="//www.lvdoui.cn/update/update10.htm?v='.$version['code'].'" width="0" height="0"></iframe>'. '<script src="//www.lvdoui.cn/update/v10/?c=check&v='.$version['code'].'&p='.PHP_VERSION.'&tp='. THINK_VERSION .'&t='.time().'"></script></span>';
    }
