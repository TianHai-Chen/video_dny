...
class Vod extends Base
{
    ...
    public function member_tip()
    {
        $info = $this->label_vod_detail();
        return $this->label_fetch('vod/member_tip');
    }
    ...
    public function play()
    {
        ...
        if($info['vod_is_member'] == 1) {
            if($GLOBALS['user']['group_id'] <= 2) {
                //$this->label_fetch('vod/member_tip');//['code' => 10003, 'msg' => '该视频需要开通会员才能观看'];
                return $this->error('<span style="color:red">该视频需要开通会员才能观看</span>', mac_url('user/index') );
            }
        }
