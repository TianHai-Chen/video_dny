...
return [
    ...
    'points_upgrade'=>'仙豆升级',
    'integral_consumption'=>'仙豆消费',
    'integral_withdrawal'=>'仙豆提现',
    'not_sale'=>'未出售',
    'sold'=>'已出售',
    'not_used'=>'未使用',
    'used'=>'已使用',
...
https://www.baidu.com/123.jpg
    ...
    'model/card/used_card_ok'=>'充值成功，增加仙豆【%s】',

    'model/cash/not_open'=>'提现功能未开启！',
    'model/cash/min_money_err'=>'最低提现金额！',
    'model/cash/mush_money_err'=>'提现太多了,没有这么多仙豆哦！',
    ...
    'model/order/update_user_points_err'=>'更新会员仙豆失败',
    ...
    'model/user/potins_not_enough'=>'仙豆不够，无法升级',
    ...
    'model/user/visit_tip'=>'每日仅能获取%s次推广访问仙豆',
    'model/user/visit_err'=>'插入推广记录失败，请重试',
    'model/user/visit_ok'=>'推广成功',
    'model/user/reward_tip'=>'用户【%s、%s】消费%S仙豆，获得奖励%s仙豆',
    ...
    'controller/pay_play_points'=>'观看此数据，需要支付【%s】仙豆，确认支付吗？',
    'controller/pay_down_points'=>'下载此数据，需要支付【%s】仙豆，确认支付吗？',
    'controller/in_try_see'=>'进入试看模式',
    'controller/charge_data'=>'此页面为收费数据，请先登录后访问！',
    'controller/try_see_end'=>'试看结束,是否支付[%s]仙豆观看完整数据？您还剩下[%s]仙豆，请先充值！',
    'controller/not_enough_points'=>'对不起,观看此页面数据需要[%s]仙豆，您还剩下[%s]仙豆，请先充值！',
    ...
    'index/buy_popedom2'=>'对不起,更新用户仙豆信息失败，请刷新重试！',
    'index/buy_popedom3'=>'对不起,查看此页面数据需要[%s]仙豆，您还剩下[%s]仙豆，请先充值！',
    ...
    'admin/system/configpay/scale_tip'=>'1元人民币等于多少仙豆',
    ...
    'admin/system/configuser/reg_points_tip'=>'用户注册成功后默认赠送仙豆',
    'admin/system/configuser/reg_num'=>'每IP限制',
    'admin/system/configuser/reg_num_tip'=>'每个IP每日限制注册次数',
    'admin/system/configuser/invite_reg_points'=>'邀请注册仙豆',
    'admin/system/configuser/invite_reg_points_tip'=>'成功邀请用户赚取奖励仙豆',
    'admin/system/configuser/invite_visit_points'=>'推广访问仙豆',
    'admin/system/configuser/invite_visit_points_tip'=>'成功邀请访问赚取奖励仙豆',
    'admin/system/configuser/invite_visit_num_tip'=>'每个IP每日限制可以获取几次推广访问仙豆',
    ...
    'admin/vod/stint_play'=>'点播每集所需仙豆',
    'admin/vod/stint_down'=>'下载每集所需仙豆',
    ...
    'admin/plog/title'=>'仙豆日志管理',
    'admin/plog/log_time'=>'日志时间',
    'admin/plog/points_recharge'=>'仙豆充值',
    'admin/plog/reg_promote'=>'注册推广',
    'admin/plog/visit_promote'=>'访问推广',
    'admin/plog/three_distribution'=>'三级分销',
    'admin/plog/points_upgrade'=>'仙豆升级',
    'admin/plog/points_buy'=>'仙豆消费',
    'admin/plog/points_withdrawal'=>'仙豆提现',
    ...
    'admin/user/reward/total_commission_points'=>'总提成仙豆',
